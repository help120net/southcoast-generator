 ...
 * huangbh
 */
public class SouthCoastPlugin extends PluginAdapter {
	
	private static Log log = LogFactory.getLog(SouthCoastPlugin.class);
    ...
    private static final String BASE_PACKAGE = "cn.south.toast.common.mybatis";
